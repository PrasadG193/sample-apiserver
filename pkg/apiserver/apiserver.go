...
func (c completedConfig) New() (*WardleServer, error) {
	...
	v1alpha1storage["flunders"] = flunderstorage.NewREST(Scheme, c.GenericConfig.RESTOptionsGetter)
	//v1alpha1storage["flunders"] = wardleregistry.RESTInPeaceStorage(flunderstorage.NewCustomREST())
	...
	v1beta1storage["flunders"] = flunderstorage.NewREST(Scheme, c.GenericConfig.RESTOptionsGetter)
